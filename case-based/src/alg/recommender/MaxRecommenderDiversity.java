...
public class MaxRecommenderDiversity extends RecommenderNonPersonalised {
    /**
     ...
     */
    public MaxRecommenderDiversity(final CaseSimilarity caseSimilarity, final DatasetReader reader) {
